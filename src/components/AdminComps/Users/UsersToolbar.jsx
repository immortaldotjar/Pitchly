...
import { roleFilters, statusFilters } from "../../../config/adminUsersConfig"

const UsersToolbar = ({ search, onSearchChange, activeRole, onRoleChange, status, onStatusChange }) => {
    return (
            ...
            <div className="flex flex-wrap gap-2">
                {roleFilters.map((role) => (
                    <button
                        ...
                        className={`px-3.5 py-2 rounded-lg font-body-sm text-[12px] font-semibold transition-colors duration-150 ${activeRole === role
